...
local function createList(option, parent, holder)
    ...
    local function CloseDropdown()
        if ToggleDropdown then
            tweenService:Create(CloseDowndrop, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = 90}):Play()
        else
            tweenService:Create(CloseDowndrop, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = 180}):Play()
        end
    end
...
function library:Init()
    ...
    elseif type(gethui) == 'function' then
        ...
        self.base.Name = "BaconScripter GUI"
        self.base.Parent = game:GetService("CoreGui")
    end
